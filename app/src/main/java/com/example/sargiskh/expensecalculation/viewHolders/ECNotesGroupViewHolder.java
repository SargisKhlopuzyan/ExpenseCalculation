package com.example.sargiskh.expensecalculation.viewHolders;
...
public class ECNotesGroupViewHolder {
    ...
    public void setData(final ECSingleNoteModel previewsModel, final ECSingleNoteModel model, boolean _isEditMode) {
